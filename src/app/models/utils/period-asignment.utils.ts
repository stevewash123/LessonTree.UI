// **COMPLETE FILE** - utils/period-assignment.utils.ts
// RESPONSIBILITY: PeriodAssignment utilities, validation, and constants
// DOES NOT: Handle model definitions (see period-assignment.model.ts)
// CALLED BY: Services that work with period assignments

import { PeriodAssignment, TeachingSchedule, PeriodCourseAssignment } from "../period-assignment";
...
export function convertFromApiFormat(apiAssignment: any): PeriodAssignment {
    return {
        ...
        teachingDays: typeof apiAssignment.teachingDays === 'string' 
            ...
            : apiAssignment.teachingDays || ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday']
    };
}
